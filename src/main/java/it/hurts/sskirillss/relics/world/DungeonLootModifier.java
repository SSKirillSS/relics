...
public class DungeonLootModifier extends LootModifier {
    ...
    public List<ItemStack> doApply(List<ItemStack> generatedLoot, LootContext context) {
        ...
        if (id.equals(LootTables.DESERT_PYRAMID) || id.equals(LootTables.VILLAGE_DESERT_HOUSE)) {
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.SCARAB_TALISMAN_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.SCARAB_TALISMAN.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.HOLY_LOCKET_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.HOLY_LOCKET.get()));
        }

        if (id.equals(LootTables.ABANDONED_MINESHAFT)) {
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.SPATIAL_SIGN_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.SPATIAL_SIGN.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.FRAGRANT_FLOWER_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.FRAGRANT_FLOWER.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.MAGIC_MIRROR_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.MAGIC_MIRROR.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.SPIDER_NECKLACE_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.SPIDER_NECKLACE.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.OUT_RUNNER_GEN_CHANCE.get())
        ...
        if (id.equals(LootTables.STRONGHOLD_CORRIDOR) || id.equals(LootTables.STRONGHOLD_CROSSING)
            ...
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.SPATIAL_SIGN_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.SPATIAL_SIGN.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.ENDERS_HAND_GEN_CHANCE.get())
        ...
        if (id.equals(LootTables.BASTION_BRIDGE) || id.equals(LootTables.BASTION_OTHER) || id.equals(LootTables.BASTION_TREASURE)
            ...
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.REFLECTION_NECKLACE_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.REFLECTION_NECKLACE.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.MAGMA_WALKER_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.MAGMA_WALKER.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.RAGE_GLOVE_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.RAGE_GLOVE.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.BASTION_RING_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.BASTION_RING.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.BLAZING_FLASK_GEN_CHANCE.get())
        ...
        if (id.equals(LootTables.END_CITY_TREASURE)) {
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.MIDNIGHT_ROBE_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.MIDNIGHT_ROBE.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.STELLAR_CATALYST_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.STELLAR_CATALYST.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.DELAY_RING_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.DELAY_RING.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.CHORUS_INHIBITOR_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.CHORUS_INHIBITOR.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.SPACE_DISSECTOR_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.SPACE_DISSECTOR.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.SOUL_DEVOURER_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.SOUL_DEVOURER.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.ENDERS_HAND_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.ENDERS_HAND.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.ELYTRA_BOOSTER_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.ELYTRA_BOOSTER.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.SHADOW_GLAIVE_GEN_CHANCE.get())
        ...
        if (id.equals(LootTables.UNDERWATER_RUIN_BIG) || id.equals(LootTables.UNDERWATER_RUIN_SMALL)
            ...
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.DROWNED_BELT_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.DROWNED_BELT.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.JELLYFISH_NECKLACE_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.JELLYFISH_NECKLACE.get()));
        }

        if (id.equals(LootTables.VILLAGE_FLETCHER)) {
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.ARROW_QUIVER_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.ARROW_QUIVER.get()));
        }

        if (id.equals(LootTables.VILLAGE_BUTCHER)) {
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.HUNTER_BELT_GEN_CHANCE.get())
        ...
        if (id.equals(LootTables.VILLAGE_SHEPHERD)) {
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.LUCKY_HORSESHOE_GEN_CHANCE.get())
        ...
        if (id.equals(LootTables.VILLAGE_SNOWY_HOUSE) || id.equals(LootTables.VILLAGE_TAIGA_HOUSE)
            ...
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.ICE_SKATES_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.ICE_SKATES.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.ICE_BREAKER_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.ICE_BREAKER.get()));
        }

        if (id.equals(LootTables.JUNGLE_TEMPLE)) {
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.CAMOUFLAGE_RING_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.CAMOUFLAGE_RING.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.FRAGRANT_FLOWER_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.FRAGRANT_FLOWER.get()));
            if (random.nextFloat() <= RelicsConfig.RelicsWorldgen.SPORE_SACK_GEN_CHANCE.get())
                generatedLoot.add(new ItemStack(ItemRegistry.SPORE_SACK.get()));
        }

        if (id.equals(LootTables.FISHING)) {
            if (random.nextFloat() <= 0.01F) generatedLoot.add(new ItemStack(ItemRegistry.OLD_BOOT.get()));
        }
