...
//            List<ItemStack> arrows = ArrowQuiverItem.getArrows(player.registryAccess(), quiver);
//
//            if (arrows.isEmpty()) {
//                this.discard();
//
...
//                    AbstractArrow entity = item.createArrow(level(), arrow, player, null);
//
...
//
//        quiver = ItemStack.parseOptional(this.registryAccess(), compound.getCompound("quiver"));
//    }
//
//    @Override
...
//
//        quiver.save(this.registryAccess(), compound.getCompound("quiver"));
//    }
//
////    @Override
