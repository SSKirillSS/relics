...
public class OutRunnerModel extends BipedModel<LivingEntity> {
    public OutRunnerModel() {
        ...
        cube_r1.texOffs(0, 0).addBox(-1.7F, 6.0F, 1.8358F, 2.0F, 4.0F, 0.0F, 0.0F, false);
        cube_r1.texOffs(9, 21).addBox(-2.7F, 5.5F, 1.8358F, 3.0F, 5.0F, 0.0F, 0.0F, false);

        ModelRenderer cube_r2 = new ModelRenderer(this);
        cube_r2.setPos(-2.0F, -12.0F, 1.4142F);
        model.addChild(cube_r2);
        setRotationAngle(cube_r2, 0.0F, -0.7854F, 0.0F);
        cube_r2.texOffs(0, 13).addBox(5.3F, 6.0F, -3.83F, 2.0F, 4.0F, 0.0F, 0.0F, false);
        cube_r2.texOffs(3, 21).addBox(5.3F, 5.5F, -3.82F, 3.0F, 5.0F, 0.0F, 0.0F, false);
    }
