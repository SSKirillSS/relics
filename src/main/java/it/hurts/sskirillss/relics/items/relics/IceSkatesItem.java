...
public class IceSkatesItem extends Item implements ICurioItem, IHasTooltip {
    ...
    public void curioTick(String identifier, int index, LivingEntity livingEntity, ItemStack stack) {
        ...
        if (livingEntity.getEntityWorld().getBlockState(livingEntity.getPosition().down()) == Fluids.WATER.getStillFluid().getDefaultState().getBlockState() && time > 0) {
            livingEntity.getEntityWorld().setBlockState(livingEntity.getPosition().down(), Blocks.PACKED_ICE.getDefaultState());
