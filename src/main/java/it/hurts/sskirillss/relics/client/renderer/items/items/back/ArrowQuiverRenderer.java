...
public class ArrowQuiverRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MODID, "textures/models/items/arrow_quiver.png");

    private final ArrowQuiverModel model;

    public ArrowQuiverRenderer() {
        this.model = new ArrowQuiverModel(Minecraft.getInstance().getEntityModels().bakeLayer(ArrowQuiverModel.LAYER));
    }
