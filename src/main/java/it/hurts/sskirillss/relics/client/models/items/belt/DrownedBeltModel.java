...
public class DrownedBeltModel extends HumanoidModel<LivingEntity> {
    public static final ModelLayerLocation LAYER = new ModelLayerLocation(new ResourceLocation(Reference.MODID, "drowned_belt"), "drowned_belt");

    public ModelPart model;

    public DrownedBeltModel(ModelPart root) {
        super(root);
