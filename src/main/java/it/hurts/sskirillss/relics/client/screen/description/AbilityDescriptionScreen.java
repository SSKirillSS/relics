...
public class AbilityDescriptionScreen extends Screen implements IAutoScaledScreen {
    ...
    public void render(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        ScreenUtils.drawCenteredString(pPoseStack, MC.font, experience, (int) ((x + 136) * 1.33F), (int) ((y + 81) * 1.33F), 0x054503, false);
        ScreenUtils.drawCenteredString(pPoseStack, MC.font, experience, (int) ((x + 134) * 1.33F), (int) ((y + 81) * 1.33F), 0x054503, false);
        ScreenUtils.drawCenteredString(pPoseStack, MC.font, experience, (int) ((x + 135) * 1.33F), (int) ((y + 82) * 1.33F), 0x054503, false);
        ScreenUtils.drawCenteredString(pPoseStack, MC.font, experience, (int) ((x + 135) * 1.33F), (int) ((y + 80.5F) * 1.33F), 0x054503, false);

        ScreenUtils.drawCenteredString(pPoseStack, MC.font, experience, (int) ((x + 135) * 1.33F), (int) ((y + 81) * 1.33F), 0x7efc20, false);
        ...
        for (String stat : AbilityUtils.getAbilityInitialValues(stack, ability).keySet()) {
            ...
            if (statData != null) {
                ...
                MC.font.draw(pPoseStack, Component.translatable("tooltip.relics." + ForgeRegistries.ITEMS.getKey(stack.getItem()).getPath() + ".ability." + ability + ".stat." + stat + ".title"), (x + 35) * 2, (y + yOff + 102) * 2, 0x412708);

                MC.font.draw(pPoseStack, Component.literal(" ● ").append(Component.translatable("tooltip.relics." + ForgeRegistries.ITEMS.getKey(stack.getItem()).getPath() + ".ability." + ability + ".stat." + stat + ".value", cost)), (x + 40) * 2, (y + yOff + 107) * 2, 0x412708);
