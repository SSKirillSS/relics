...
public class JellyfishNecklaceRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MODID, "textures/models/items/jellyfish_necklace.png");

    private final JellyfishNecklaceModel model;

    public JellyfishNecklaceRenderer() {
        this.model = new JellyfishNecklaceModel(Minecraft.getInstance().getEntityModels().bakeLayer(JellyfishNecklaceModel.LAYER));
    }
