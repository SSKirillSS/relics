...
public class IceCubeModel extends HumanoidModel<LivingEntity> {
    public static final ModelLayerLocation TEXTURE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Reference.MODID, "order/textures/please"), "cube");
