...
public class AbilityRerollButtonWidget extends AbstractDescriptionWidget implements IHoverableWidget, ITickingWidget {
    ...
    public void renderButton(PoseStack poseStack, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        blit(poseStack, x, y, isLocked() ? 320 : 302, 88, width, height, 512, 512);
    ...
    public void onHovered(PoseStack poseStack, int mouseX, int mouseY) {
        ...
        List<MutableComponent> entries = Lists.newArrayList(
                new TranslatableComponent("tooltip.relics.relic.reroll.description").withStyle(ChatFormatting.BOLD),
                new TextComponent(" "),
                new TranslatableComponent("tooltip.relics.relic.reroll.cost", requiredExperience,
