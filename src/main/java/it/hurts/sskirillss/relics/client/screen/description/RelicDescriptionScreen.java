...
public class RelicDescriptionScreen extends Screen implements IAutoScaledScreen {
    ...
    public void render(GuiGraphics guiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        ScreenUtils.drawCenteredString(guiGraphics, MC.font, experience, (int) ((x + 136) * 1.33F), (int) ((y + 71) * 1.33F), 0x793300, false);
        ScreenUtils.drawCenteredString(guiGraphics, MC.font, experience, (int) ((x + 134) * 1.33F), (int) ((y + 71) * 1.33F), 0x793300, false);
        ScreenUtils.drawCenteredString(guiGraphics, MC.font, experience, (int) ((x + 135) * 1.33F), (int) ((y + 72) * 1.33F), 0x793300, false);
        ScreenUtils.drawCenteredString(guiGraphics, MC.font, experience, (int) ((x + 135) * 1.33F), (int) ((y + 70.5F) * 1.33F), 0x793300, false);

        ScreenUtils.drawCenteredString(guiGraphics, MC.font, experience, (int) ((x + 135) * 1.33F), (int) ((y + 71) * 1.33F), 0xfff500, false);

        experience = Component.literal(String.valueOf(player.experienceLevel));

        ScreenUtils.drawCenteredString(guiGraphics, MC.font, experience, (int) ((x + 136) * 1.33F), (int) ((y + 84) * 1.33F), 0x054503, false);
        ScreenUtils.drawCenteredString(guiGraphics, MC.font, experience, (int) ((x + 134) * 1.33F), (int) ((y + 84) * 1.33F), 0x054503, false);
        ScreenUtils.drawCenteredString(guiGraphics, MC.font, experience, (int) ((x + 135) * 1.33F), (int) ((y + 85) * 1.33F), 0x054503, false);
        ScreenUtils.drawCenteredString(guiGraphics, MC.font, experience, (int) ((x + 135) * 1.33F), (int) ((y + 83.5F) * 1.33F), 0x054503, false);

        ScreenUtils.drawCenteredString(guiGraphics, MC.font, experience, (int) ((x + 135) * 1.33F), (int) ((y + 84) * 1.33F), 0x7efc20, false);
